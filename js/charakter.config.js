const CHARAKTER_ASSETS = Object.freeze({
    hurt: Object.freeze([
...
const CHARAKTER_DEFAULTS = Object.freeze({
    ...
    acceleration: 2,
    gravity: 1,
    offset: Object.freeze({ top: 95, right: 35, bottom: 10, left: 35 }),
    walkingVolume: 0.25,
    normalJumpStartFrameIndex: 3,
    fastJumpFrameCount: 4,
    stompJumpFrameIndex: 4,
